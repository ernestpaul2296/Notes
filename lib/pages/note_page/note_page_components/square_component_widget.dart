...
class SquareComponentWidget extends StatefulWidget {
  const SquareComponentWidget({
    Key? key,
    required this.id,
    required this.e,
  }) : super(key: key);
  ...
  @override
  State<SquareComponentWidget> createState() => _SquareComponentWidgetState();
}

class _SquareComponentWidgetState extends State<SquareComponentWidget> {
  @override
